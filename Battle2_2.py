...
def createSub(gridSize, placementType, board, player, shipID1, shipID2):
    ...
    if placementType == 1:
        ...
        if player == "Player 1":
            ...
            xLetter2 = parkedShip2[0]
            yNumber2 = int(parkedShip2[1])
            str_correlate2 = f"({xLetter2},{yNumber2})"
