...
def bombTarget(userBomb, board, player,shipID1, shipID2, destName, destName2, subName, subName2):
        if player == "Player 1":
            ...
            for i in range(0, len(keys)):
                ...
                if placehold not in sscoordlist:
            ...
            if placeholdc not in sscoordlist2:
...
def createDest(gridSize, placementType, board, player, shipID1, shipID2):
    ...
    if placementType == 1:
        ...
        if player == "Player 1":
            ...
            board[newCol][int(yNumber) - 1] = Fore.GREEN + "#" + Fore.RESET
            ...
            board[newCol][int(yNumber2) -1] = Fore.GREEN + "#" + Fore.RESET
            coordlist = [(str_correlate,str_correlate2)]
