...
def bombTarget(userBomb, board):
    ...
    if placehold not in p1Dest or placehold not in p1Sub or placehold not in p1Cruise or placehold not in p1Battle or placehold not in p1Air:
...
def shipCreateS(p1Ship1, p1Ship2, p2Ship1, p2Ship2, player):
...
def placementStyle(playtype, player):
    if playtype == 1:
        shipCreateS(p1Ship1, p1Ship2, p2Ship1, p2Ship2, player)
    else:
        shipManual()
